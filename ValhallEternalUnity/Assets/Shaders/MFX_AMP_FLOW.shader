...
Shader "MFX_AMP_FLOW"
{
	Properties
	{
		...
		_EmissiveColor( "Emissive Color", Color ) = ( 0.1364862, 0.6603774, 0, 0.8 )
...
#define _EmissiveColor_arr MFX_AMP_FLOW
...
#define _Intensity_arr MFX_AMP_FLOW
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult20 = lerp( _EmissiveColor_Instance , 0 , float4( 0,0,0,0 ));
...
Node;AmplifyShaderEditor.Vector2Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;9;-800,-48;Inherit;False;Property;_Movement;Movement;1;0;Create;True;0;0;0;False;0;False;0.1,0;0,-0.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;21;-608,80;Inherit;True;Property;_Texture0;Texture 0;5;0;Create;True;0;0;0;False;0;False;None;42801cdecf480ff4a815d84f008b551b;False;white;Auto;Texture2D;False;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;11;-192,144;Inherit;False;InstancedProperty;_Intensity;Intensity;2;0;Create;True;0;0;0;False;0;False;5;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;10;-208,-400;Inherit;False;InstancedProperty;_EmissiveColor;Emissive Color;3;0;Create;True;0;0;0;False;0;False;0.1364862,0.6603774,0,0.8;0.1364862,0.6603774,0,0.8;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;15;-144,240;Inherit;False;Property;_MaskIntensity;Mask Intensity;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=D4AAF2D907D5C3003962D7EF083C25C4C07ACEAE